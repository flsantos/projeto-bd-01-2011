...
<div id="logo">
	<?php
	 ...
	 ?>
	<h2> &raquo;&nbsp;&nbsp;&nbsp;novo Técnico/Gestor</h2>
</div>
<div id="header">
	<div id="menu">
		<ul>
			...
			<div class="entry">
				<?=form_open('tecnicogestor/alterando');?>
					...
					<div>
						...
						<?=form_radio('estado_civil', 4, $pessoas ? ($pessoas[0]->estado_civil == 4 ? TRUE : '') : '')?> <?=form_label('Vi�vo(a)', 'ec_viuvo')?>
					</div>
					<div>
					...
					<div>
						...
						<?=form_input('end_institucional', $tecnicogestor ? $tecnicogestor[0]->end_institucional : 'QE 26 Conjunto O casa 12 - Guar� II', '')?>
					</div>
					<div>
					...
					<div id="titulacoes">
						<?php if ($titulacoes != null):?>
							...
							<?php foreach ($titulacoes as $titulacao):?>
								<div id="titulacao<?=$k?>">
									<?=form_radio('titulacao'.$k, 1, $tecnicogestor ? ($titulacao->titulacao_id == 1 ? TRUE : '') : 'TRUE')?> Gradua��o
									<?=form_radio('titulacao'.$k, 2, $tecnicogestor ? ($titulacao->titulacao_id == 2 ? TRUE : '') : '')?> Aperfei�oamento
									<?=form_radio('titulacao'.$k, 3, $tecnicogestor ? ($titulacao->titulacao_id == 3 ? TRUE : '') : '')?> Especializa��o
									...
									<?=form_radio('titulacao'.$k, 6, $tecnicogestor ? ($titulacao->titulacao_id == 6 ? TRUE : '') : '')?> P�s-Doutorado  ---    
